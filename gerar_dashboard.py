...
<body>
  ...
  <script>
    ...
    function renderResumoTecnicosPainel() {{
      ...
      resumoTecnicosMeta.textContent = `Mostrando ${{itens.length}} técnico(s) do grupo Técnicos com O.S. iniciais, total atual, entradas e saídas no intervalo selecionado.`;
    }}
